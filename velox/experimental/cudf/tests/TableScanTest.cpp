...
// DECIMAL64 in cuDF. IF/CASE must widen operands before copy_if_else.
...
// Parquet scan columns are DECIMAL32 for precision <= 9; subfield filter
// literals must match or cuDF AST parsing fails.
